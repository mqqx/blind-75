...
class PacificAtlanticWaterFlowTest {
  ...
  private PacificAtlanticWaterFlow pacificAtlanticWaterFlowUnderTest;

  @BeforeEach
  void setUp() {
    pacificAtlanticWaterFlowUnderTest = new PacificAtlanticWaterFlow();
  }

  @MethodSource
  @ParameterizedTest
  void testPacificAtlantic(int[][] heights, List<List<Integer>> expected) {
    assertThat(pacificAtlanticWaterFlowUnderTest.pacificAtlantic(heights)).isEqualTo(expected);
  }
