...
class InsertIntervalTest {
  ...
  private InsertInterval insertIntervalUnderTest;

  @BeforeEach
  void setUp() {
    insertIntervalUnderTest = new InsertInterval();
  }
  ...
  void testInsert(int[][] intervals, int[] newInterval, int[][] expected) {
    // Run the test
    final int[][] result = insertIntervalUnderTest.insert(intervals, newInterval);
